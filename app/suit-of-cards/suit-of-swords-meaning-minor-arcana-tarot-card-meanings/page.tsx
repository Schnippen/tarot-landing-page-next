...
export async function generateMetadata({
  ...
  return {
    title: SuitsNamesMetaTagsData[2],
    description: SuitsMetaTagsData[2],
  };
}
  ...
  return (
    <main className={styles.main}>
      <div className={styles.article_container}>
        <Article title={SuitOfArticlesData[2].SuitName}>
          {SuitOfArticlesData[2].SuitFirstTitle}
          {SuitOfArticlesData[2].SuitFirstArticle}
          <div style={{ width: "100%" }}>
            <Separator marginHeight={48} />
          </div>
          {SuitOfArticlesData[2].SuitSecondTitle}
          {SuitOfArticlesData[2].SuitSecondArticle}
          <Separator marginHeight={48} />
          {SuitOfArticlesData[2].SuitThirdTitle}
          {SuitOfArticlesData[2].SuitThirdArticle}
          <Separator marginHeight={48} />
          {SuitOfArticlesData[2].SuitFourthTitle}
          {SuitOfArticlesData[2].SuitFourthArticle}
        </Article>
        ...
        <Article title={SuitOfArticlesData[2].SuitName}>
          <ul style={{ padding: "0px" }}>
            {SuitOfAllCards[2].slice(0, 7).map((item, index) => (
              <>
                <CardDisplayItem
                  alt={item.alt}
                  ...
                  href={item.href}
                />
                {SuitOfAllCards[2].length / 2 === index + 1 ? (
                  <></>
                ) : (
                  <Separator marginHeight={48} />
                )}
        ...
        <Article title="">
          <ul style={{ padding: "0px" }}>
            {SuitOfAllCards[2].slice(7, 14).map((item, index) => (
              <>
                <CardDisplayItem
                  alt={item.alt}
                  tooltip={item.tooltip}
                  ...
                  href={item.href}
                />
                {SuitOfAllCards[2].length === index + 1 ? (
                  <></>
                ) : (
                  <Separator marginHeight={48} />
                )}
