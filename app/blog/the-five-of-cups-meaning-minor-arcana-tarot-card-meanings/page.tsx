...
export async function generateMetadata({
  ...
  return {
    title: TarotCardsAllFullDescriptionData[40].tooltip + " " + "Meaning",
    description: CardsMetaTagsData[40],
  };
}
  ...
  return (
    <main className={styles.main}>
      <div className={styles.article_container}>
        <Article title={TarotCardsAllFullDescriptionData[40].CardName}>
          <div
            style={{
              display: "flex",
          ...
          >
            <Card img={TarotCardsPhotosAll[40]} />
          </div>
          {TarotCardsAllFullDescriptionData[40].SubTitle}
          {TarotCardsAllFullDescriptionData[40].Introduction}
          <div style={{ width: "100%" }}>
            <Separator marginHeight={48} />
          </div>
          {TarotCardsAllFullDescriptionData[40].SymbolismTitle}
          {TarotCardsAllFullDescriptionData[40].Symbolism}
        </Article>

        <Article title={TarotCardsAllFullDescriptionData[40].CardMeaning}>
          {TarotCardsAllFullDescriptionData[40].CardMeaningArticle}
        </Article>
        <span style={{ width: "100%", margin: "24px" }}></span>
        <TarotMeaningsExpositionContainer />
        <span style={{ width: "100%", margin: "24px" }}></span>
        <Article title="Card comparisons">
          {TarotCardsComparisionsData[40]()}
        </Article>
      </div>
    </main>
  );
