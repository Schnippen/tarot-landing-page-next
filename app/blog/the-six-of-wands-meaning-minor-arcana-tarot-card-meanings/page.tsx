...
export async function generateMetadata({
  ...
  return {
    title: TarotCardsAllFullDescriptionData[27].tooltip + " " + "Meaning",
    description: CardsMetaTagsData[27],
  };
}
  ...
  return (
    <main className={styles.main}>
      <div className={styles.article_container}>
        <Article title={TarotCardsAllFullDescriptionData[27].CardName}>
          <div
            style={{
              display: "flex",
          ...
          >
            <Card img={TarotCardsPhotosAll[27]} />
          </div>
          {TarotCardsAllFullDescriptionData[27].SubTitle}
          {TarotCardsAllFullDescriptionData[27].Introduction}
          <div style={{ width: "100%" }}>
            <Separator marginHeight={48} />
          </div>
          {TarotCardsAllFullDescriptionData[27].SymbolismTitle}
          {TarotCardsAllFullDescriptionData[27].Symbolism}
        </Article>

        <Article title={TarotCardsAllFullDescriptionData[27].CardMeaning}>
          {TarotCardsAllFullDescriptionData[27].CardMeaningArticle}
        </Article>
        <span style={{ width: "100%", margin: "24px" }}></span>
        <TarotMeaningsExpositionContainer />
        <span style={{ width: "100%", margin: "24px" }}></span>
        <Article title="Card comparisons">
          {TarotCardsComparisionsData[27]()}
        </Article>
      </div>
    </main>
  );
