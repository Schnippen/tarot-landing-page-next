...
export async function generateMetadata({
  ...
  return {
    title: TarotCardsAllFullDescriptionData[63].tooltip + " " + "Meaning",
    description: CardsMetaTagsData[63],
  };
}
  ...
  return (
    <main className={styles.main}>
      <div className={styles.article_container}>
        <Article title={TarotCardsAllFullDescriptionData[63].CardName}>
          <div
            style={{
              display: "flex",
          ...
          >
            <Card img={TarotCardsPhotosAll[63]} />
          </div>
          {TarotCardsAllFullDescriptionData[63].SubTitle}
          {TarotCardsAllFullDescriptionData[63].Introduction}
          <div style={{ width: "100%" }}>
            <Separator marginHeight={48} />
          </div>
          {TarotCardsAllFullDescriptionData[63].SymbolismTitle}
          {TarotCardsAllFullDescriptionData[63].Symbolism}
        </Article>

        <Article title={TarotCardsAllFullDescriptionData[63].CardMeaning}>
          {TarotCardsAllFullDescriptionData[63].CardMeaningArticle}
        </Article>
        <span style={{ width: "100%", margin: "24px" }}></span>
        <TarotMeaningsExpositionContainer />
        <span style={{ width: "100%", margin: "24px" }}></span>
        <Article title="Card comparisons">
          {TarotCardsComparisionsData[63]()}
        </Article>
      </div>
    </main>
  );
