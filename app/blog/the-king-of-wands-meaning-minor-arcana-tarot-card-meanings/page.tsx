...
export async function generateMetadata({
  ...
  return {
    title: TarotCardsAllFullDescriptionData[35].tooltip + " " + "Meaning",
    description: CardsMetaTagsData[35],
  };
}
  ...
  return (
    <main className={styles.main}>
      <div className={styles.article_container}>
        <Article title={TarotCardsAllFullDescriptionData[35].CardName}>
          <div
            style={{
              display: "flex",
          ...
          >
            <Card img={TarotCardsPhotosAll[35]} />
          </div>
          {TarotCardsAllFullDescriptionData[35].SubTitle}
          {TarotCardsAllFullDescriptionData[35].Introduction}
          <div style={{ width: "100%" }}>
            <Separator marginHeight={48} />
          </div>
          {TarotCardsAllFullDescriptionData[35].SymbolismTitle}
          {TarotCardsAllFullDescriptionData[35].Symbolism}
        </Article>

        <Article title={TarotCardsAllFullDescriptionData[35].CardMeaning}>
          {TarotCardsAllFullDescriptionData[35].CardMeaningArticle}
        </Article>
        <span style={{ width: "100%", margin: "24px" }}></span>
        <TarotMeaningsExpositionContainer />
        <span style={{ width: "100%", margin: "24px" }}></span>
        <Article title="Card comparisons">
          {TarotCardsComparisionsData[35]()}
        </Article>
      </div>
    </main>
  );
