...
export async function generateMetadata({
  ...
  return {
    title: TarotCardsAllFullDescriptionData[8].tooltip + " " + "Meaning",
    description: CardsMetaTagsData[8],
  };
}
  ...
  return (
    <main className={styles.main}>
      <div className={styles.article_container}>
        <Article title={TarotCardsAllFullDescriptionData[8].CardName}>
          <div
            style={{
              display: "flex",
          ...
          >
            <Card img={TarotCardsPhotosAll[8]} />
          </div>
          {TarotCardsAllFullDescriptionData[8].SubTitle}
          {TarotCardsAllFullDescriptionData[8].Introduction}
          <div style={{ width: "100%" }}>
            <Separator marginHeight={48} />
          </div>
          {TarotCardsAllFullDescriptionData[8].SymbolismTitle}
          {TarotCardsAllFullDescriptionData[8].Symbolism}
        </Article>

        <Article title={TarotCardsAllFullDescriptionData[8].CardMeaning}>
          {TarotCardsAllFullDescriptionData[8].CardMeaningArticle}
        </Article>
        <span style={{ width: "100%", margin: "24px" }}></span>
        <TarotMeaningsExpositionContainer />
        <span style={{ width: "100%", margin: "24px" }}></span>
        <Article title="Card comparisons">
          {TarotCardsComparisionsData[8]()}
        </Article>
      </div>
    </main>
  );
