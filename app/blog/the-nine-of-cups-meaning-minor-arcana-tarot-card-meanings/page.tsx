...
export async function generateMetadata({
  ...
  return {
    title: TarotCardsAllFullDescriptionData[44].tooltip + " " + "Meaning",
    description: CardsMetaTagsData[44],
  };
}
  ...
  return (
    <main className={styles.main}>
      <div className={styles.article_container}>
        <Article title={TarotCardsAllFullDescriptionData[44].CardName}>
          <div
            style={{
              display: "flex",
          ...
          >
            <Card img={TarotCardsPhotosAll[44]} />
          </div>
          {TarotCardsAllFullDescriptionData[44].SubTitle}
          {TarotCardsAllFullDescriptionData[44].Introduction}
          <div style={{ width: "100%" }}>
            <Separator marginHeight={48} />
          </div>
          {TarotCardsAllFullDescriptionData[44].SymbolismTitle}
          {TarotCardsAllFullDescriptionData[44].Symbolism}
        </Article>

        <Article title={TarotCardsAllFullDescriptionData[44].CardMeaning}>
          {TarotCardsAllFullDescriptionData[44].CardMeaningArticle}
        </Article>
        <span style={{ width: "100%", margin: "24px" }}></span>
        <TarotMeaningsExpositionContainer />
        <span style={{ width: "100%", margin: "24px" }}></span>
        <Article title="Card comparisons">
          {TarotCardsComparisionsData[44]()}
        </Article>
      </div>
    </main>
  );
