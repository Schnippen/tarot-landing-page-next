...
export async function generateMetadata({
  ...
  return {
    title: TarotCardsAllFullDescriptionData[52].tooltip + " " + "Meaning",
    description: CardsMetaTagsData[52],
  };
}
  ...
  return (
    <main className={styles.main}>
      <div className={styles.article_container}>
        <Article title={TarotCardsAllFullDescriptionData[52].CardName}>
          <div
            style={{
              display: "flex",
          ...
          >
            <Card img={TarotCardsPhotosAll[52]} />
          </div>
          {TarotCardsAllFullDescriptionData[52].SubTitle}
          {TarotCardsAllFullDescriptionData[52].Introduction}
          <div style={{ width: "100%" }}>
            <Separator marginHeight={48} />
          </div>
          {TarotCardsAllFullDescriptionData[52].SymbolismTitle}
          {TarotCardsAllFullDescriptionData[52].Symbolism}
        </Article>

        <Article title={TarotCardsAllFullDescriptionData[52].CardMeaning}>
          {TarotCardsAllFullDescriptionData[52].CardMeaningArticle}
        </Article>
        <span style={{ width: "100%", margin: "24px" }}></span>
        <TarotMeaningsExpositionContainer />
        <span style={{ width: "100%", margin: "24px" }}></span>
        <Article title="Card comparisons">
          {TarotCardsComparisionsData[52]()}
        </Article>
      </div>
    </main>
  );
