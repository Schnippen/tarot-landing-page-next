...
export async function generateMetadata({
  ...
  return {
    title: TarotCardsAllFullDescriptionData[76].tooltip + " " + "Meaning",
    description: CardsMetaTagsData[76],
  };
}
  ...
  return (
    <main className={styles.main}>
      <div className={styles.article_container}>
        <Article title={TarotCardsAllFullDescriptionData[76].CardName}>
          <div
            style={{
              display: "flex",
          ...
          >
            <Card img={TarotCardsPhotosAll[76]} />
          </div>
          {TarotCardsAllFullDescriptionData[76].SubTitle}
          {TarotCardsAllFullDescriptionData[76].Introduction}
          <div style={{ width: "100%" }}>
            <Separator marginHeight={48} />
          </div>
          {TarotCardsAllFullDescriptionData[76].SymbolismTitle}
          {TarotCardsAllFullDescriptionData[76].Symbolism}
        </Article>

        <Article title={TarotCardsAllFullDescriptionData[76].CardMeaning}>
          {TarotCardsAllFullDescriptionData[76].CardMeaningArticle}
        </Article>
        <span style={{ width: "100%", margin: "24px" }}></span>
        <TarotMeaningsExpositionContainer />
        <span style={{ width: "100%", margin: "24px" }}></span>
        <Article title="Card comparisons">
          {TarotCardsComparisionsData[76]()}
        </Article>
      </div>
    </main>
  );
