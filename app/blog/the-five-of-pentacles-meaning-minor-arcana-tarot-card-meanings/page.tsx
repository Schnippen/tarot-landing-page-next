...
export async function generateMetadata({
  ...
  return {
    title: TarotCardsAllFullDescriptionData[68].tooltip + " " + "Meaning",
    description: CardsMetaTagsData[68],
  };
}
  ...
  return (
    <main className={styles.main}>
      <div className={styles.article_container}>
        <Article title={TarotCardsAllFullDescriptionData[68].CardName}>
          <div
            style={{
              display: "flex",
          ...
          >
            <Card img={TarotCardsPhotosAll[68]} />
          </div>
          {TarotCardsAllFullDescriptionData[68].SubTitle}
          {TarotCardsAllFullDescriptionData[68].Introduction}
          <div style={{ width: "100%" }}>
            <Separator marginHeight={48} />
          </div>
          {TarotCardsAllFullDescriptionData[68].SymbolismTitle}
          {TarotCardsAllFullDescriptionData[68].Symbolism}
        </Article>

        <Article title={TarotCardsAllFullDescriptionData[68].CardMeaning}>
          {TarotCardsAllFullDescriptionData[68].CardMeaningArticle}
        </Article>
        <span style={{ width: "100%", margin: "24px" }}></span>
        <TarotMeaningsExpositionContainer />
        <span style={{ width: "100%", margin: "24px" }}></span>
        <Article title="Card comparisons">
          {TarotCardsComparisionsData[68]()}
        </Article>
      </div>
    </main>
  );
