...
export async function generateMetadata({
  ...
  return {
    title: TarotCardsAllFullDescriptionData[69].tooltip + " " + "Meaning",
    description: CardsMetaTagsData[69],
  };
}
  ...
  return (
    <main className={styles.main}>
      <div className={styles.article_container}>
        <Article title={TarotCardsAllFullDescriptionData[69].CardName}>
          <div
            style={{
              display: "flex",
          ...
          >
            <Card img={TarotCardsPhotosAll[69]} />
          </div>
          {TarotCardsAllFullDescriptionData[69].SubTitle}
          {TarotCardsAllFullDescriptionData[69].Introduction}
          <div style={{ width: "100%" }}>
            <Separator marginHeight={48} />
          </div>
          {TarotCardsAllFullDescriptionData[69].SymbolismTitle}
          {TarotCardsAllFullDescriptionData[69].Symbolism}
        </Article>

        <Article title={TarotCardsAllFullDescriptionData[69].CardMeaning}>
          {TarotCardsAllFullDescriptionData[69].CardMeaningArticle}
        </Article>
        <span style={{ width: "100%", margin: "24px" }}></span>
        <TarotMeaningsExpositionContainer />
        <span style={{ width: "100%", margin: "24px" }}></span>
        <Article title="Card comparisons">
          {TarotCardsComparisionsData[69]()}
        </Article>
      </div>
    </main>
  );
