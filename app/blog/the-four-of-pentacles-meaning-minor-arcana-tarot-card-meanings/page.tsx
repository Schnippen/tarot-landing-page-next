...
export async function generateMetadata({
  ...
  return {
    title: TarotCardsAllFullDescriptionData[67].tooltip + " " + "Meaning",
    description: CardsMetaTagsData[67],
  };
}
  ...
  return (
    <main className={styles.main}>
      <div className={styles.article_container}>
        <Article title={TarotCardsAllFullDescriptionData[67].CardName}>
          <div
            style={{
              display: "flex",
          ...
          >
            <Card img={TarotCardsPhotosAll[67]} />
          </div>
          {TarotCardsAllFullDescriptionData[67].SubTitle}
          {TarotCardsAllFullDescriptionData[67].Introduction}
          <div style={{ width: "100%" }}>
            <Separator marginHeight={48} />
          </div>
          {TarotCardsAllFullDescriptionData[67].SymbolismTitle}
          {TarotCardsAllFullDescriptionData[67].Symbolism}
        </Article>

        <Article title={TarotCardsAllFullDescriptionData[67].CardMeaning}>
          {TarotCardsAllFullDescriptionData[67].CardMeaningArticle}
        </Article>
        <span style={{ width: "100%", margin: "24px" }}></span>
        <TarotMeaningsExpositionContainer />
        <span style={{ width: "100%", margin: "24px" }}></span>
        <Article title="Card comparisons">
          {TarotCardsComparisionsData[67]()}
        </Article>
      </div>
    </main>
  );
