...
export async function generateMetadata({
  ...
  return {
    title: TarotCardsAllFullDescriptionData[19].tooltip + " " + "Meaning",
    description: CardsMetaTagsData[19],
  };
}
  ...
  return (
    <main className={styles.main}>
      <div className={styles.article_container}>
        <Article title={TarotCardsAllFullDescriptionData[19].CardName}>
          <div
            style={{
              display: "flex",
          ...
          >
            <Card img={TarotCardsPhotosAll[19]} />
          </div>
          {TarotCardsAllFullDescriptionData[19].SubTitle}
          {TarotCardsAllFullDescriptionData[19].Introduction}
          <div style={{ width: "100%" }}>
            <Separator marginHeight={48} />
          </div>
          {TarotCardsAllFullDescriptionData[19].SymbolismTitle}
          {TarotCardsAllFullDescriptionData[19].Symbolism}
        </Article>

        <Article title={TarotCardsAllFullDescriptionData[19].CardMeaning}>
          {TarotCardsAllFullDescriptionData[19].CardMeaningArticle}
        </Article>
        <span style={{ width: "100%", margin: "24px" }}></span>
        <TarotMeaningsExpositionContainer />
        <span style={{ width: "100%", margin: "24px" }}></span>
        <Article title="Card comparisons">
          {TarotCardsComparisionsData[19]()}
        </Article>
      </div>
    </main>
  );
