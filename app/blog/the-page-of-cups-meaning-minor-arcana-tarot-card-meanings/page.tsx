...
export async function generateMetadata({
  ...
  return {
    title: TarotCardsAllFullDescriptionData[46].tooltip + " " + "Meaning",
    description: CardsMetaTagsData[46],
  };
}
  ...
  return (
    <main className={styles.main}>
      <div className={styles.article_container}>
        <Article title={TarotCardsAllFullDescriptionData[46].CardName}>
          <div
            style={{
              display: "flex",
          ...
          >
            <Card img={TarotCardsPhotosAll[46]} />
          </div>
          {TarotCardsAllFullDescriptionData[46].SubTitle}
          {TarotCardsAllFullDescriptionData[46].Introduction}
          <div style={{ width: "100%" }}>
            <Separator marginHeight={48} />
          </div>
          {TarotCardsAllFullDescriptionData[46].SymbolismTitle}
          {TarotCardsAllFullDescriptionData[46].Symbolism}
        </Article>

        <Article title={TarotCardsAllFullDescriptionData[46].CardMeaning}>
          {TarotCardsAllFullDescriptionData[46].CardMeaningArticle}
        </Article>
        <span style={{ width: "100%", margin: "24px" }}></span>
        <TarotMeaningsExpositionContainer />
        <span style={{ width: "100%", margin: "24px" }}></span>
        <Article title="Card comparisons">
          {TarotCardsComparisionsData[46]()}
        </Article>
      </div>
    </main>
  );
