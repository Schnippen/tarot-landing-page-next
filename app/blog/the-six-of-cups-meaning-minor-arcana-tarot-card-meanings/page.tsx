...
export async function generateMetadata({
  ...
  return {
    title: TarotCardsAllFullDescriptionData[41].tooltip + " " + "Meaning",
    description: CardsMetaTagsData[41],
  };
}
  ...
  return (
    <main className={styles.main}>
      <div className={styles.article_container}>
        <Article title={TarotCardsAllFullDescriptionData[41].CardName}>
          <div
            style={{
              display: "flex",
          ...
          >
            <Card img={TarotCardsPhotosAll[41]} />
          </div>
          {TarotCardsAllFullDescriptionData[41].SubTitle}
          {TarotCardsAllFullDescriptionData[41].Introduction}
          <div style={{ width: "100%" }}>
            <Separator marginHeight={48} />
          </div>
          {TarotCardsAllFullDescriptionData[41].SymbolismTitle}
          {TarotCardsAllFullDescriptionData[41].Symbolism}
        </Article>

        <Article title={TarotCardsAllFullDescriptionData[41].CardMeaning}>
          {TarotCardsAllFullDescriptionData[41].CardMeaningArticle}
        </Article>
        <span style={{ width: "100%", margin: "24px" }}></span>
        <TarotMeaningsExpositionContainer />
        <span style={{ width: "100%", margin: "24px" }}></span>
        <Article title="Card comparisons">
          {TarotCardsComparisionsData[41]()}
        </Article>
      </div>
    </main>
  );
