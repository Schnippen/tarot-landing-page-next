...
export async function generateMetadata({
  ...
  return {
    title: TarotCardsAllFullDescriptionData[42].tooltip + " " + "Meaning",
    description: CardsMetaTagsData[42],
  };
}
  ...
  return (
    <main className={styles.main}>
      <div className={styles.article_container}>
        <Article title={TarotCardsAllFullDescriptionData[42].CardName}>
          <div
            style={{
              display: "flex",
          ...
          >
            <Card img={TarotCardsPhotosAll[42]} />
          </div>
          {TarotCardsAllFullDescriptionData[42].SubTitle}
          {TarotCardsAllFullDescriptionData[42].Introduction}
          <div style={{ width: "100%" }}>
            <Separator marginHeight={48} />
          </div>
          {TarotCardsAllFullDescriptionData[42].SymbolismTitle}
          {TarotCardsAllFullDescriptionData[42].Symbolism}
        </Article>

        <Article title={TarotCardsAllFullDescriptionData[42].CardMeaning}>
          {TarotCardsAllFullDescriptionData[42].CardMeaningArticle}
        </Article>
        <span style={{ width: "100%", margin: "24px" }}></span>
        <TarotMeaningsExpositionContainer />
        <span style={{ width: "100%", margin: "24px" }}></span>
        <Article title="Card comparisons">
          {TarotCardsComparisionsData[42]()}
        </Article>
      </div>
    </main>
  );
