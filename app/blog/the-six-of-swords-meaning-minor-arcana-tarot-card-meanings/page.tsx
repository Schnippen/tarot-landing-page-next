...
export async function generateMetadata({
  ...
  return {
    title: TarotCardsAllFullDescriptionData[55].tooltip + " " + "Meaning",
    description: CardsMetaTagsData[55],
  };
}
  ...
  return (
    <main className={styles.main}>
      <div className={styles.article_container}>
        <Article title={TarotCardsAllFullDescriptionData[55].CardName}>
          <div
            style={{
              display: "flex",
          ...
          >
            <Card img={TarotCardsPhotosAll[55]} />
          </div>
          {TarotCardsAllFullDescriptionData[55].SubTitle}
          {TarotCardsAllFullDescriptionData[55].Introduction}
          <div style={{ width: "100%" }}>
            <Separator marginHeight={48} />
          </div>
          {TarotCardsAllFullDescriptionData[55].SymbolismTitle}
          {TarotCardsAllFullDescriptionData[55].Symbolism}
        </Article>

        <Article title={TarotCardsAllFullDescriptionData[55].CardMeaning}>
          {TarotCardsAllFullDescriptionData[55].CardMeaningArticle}
        </Article>
        <span style={{ width: "100%", margin: "24px" }}></span>
        <TarotMeaningsExpositionContainer />
        <span style={{ width: "100%", margin: "24px" }}></span>
        <Article title="Card comparisons">
          {TarotCardsComparisionsData[55]()}
        </Article>
      </div>
    </main>
  );
