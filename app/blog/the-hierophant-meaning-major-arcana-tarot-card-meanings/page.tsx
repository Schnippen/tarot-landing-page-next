...
export async function generateMetadata({
  ...
  return {
    title: TarotCardsAllFullDescriptionData[5].tooltip + " " + "Meaning",
    description: CardsMetaTagsData[5],
  };
}
  ...
  return (
    <main className={styles.main}>
      <div className={styles.article_container}>
        <Article title={TarotCardsAllFullDescriptionData[5].CardName}>
          <div
            style={{
              display: "flex",
          ...
          >
            <Card img={TarotCardsPhotosAll[5]} />
          </div>
          {TarotCardsAllFullDescriptionData[5].SubTitle}
          {TarotCardsAllFullDescriptionData[5].Introduction}
          <div style={{ width: "100%" }}>
            <Separator marginHeight={48} />
          </div>
          {TarotCardsAllFullDescriptionData[5].SymbolismTitle}
          {TarotCardsAllFullDescriptionData[5].Symbolism}
        </Article>

        <Article title={TarotCardsAllFullDescriptionData[5].CardMeaning}>
          {TarotCardsAllFullDescriptionData[5].CardMeaningArticle}
        </Article>
        <span style={{ width: "100%", margin: "24px" }}></span>
        <TarotMeaningsExpositionContainer />
        <span style={{ width: "100%", margin: "24px" }}></span>
        <Article title="Card comparisons">
          {TarotCardsComparisionsData[5]()}
        </Article>
      </div>
    </main>
  );
