...
export async function generateMetadata({
  ...
  return {
    title: TarotCardsAllFullDescriptionData[4].tooltip + " " + "Meaning",
    description: CardsMetaTagsData[4],
  };
}
  ...
  return (
    <main className={styles.main}>
      <div className={styles.article_container}>
        <Article title={TarotCardsAllFullDescriptionData[4].CardName}>
          <div
            style={{
              display: "flex",
          ...
          >
            <Card img={TarotCardsPhotosAll[4]} />
          </div>
          {TarotCardsAllFullDescriptionData[4].SubTitle}
          {TarotCardsAllFullDescriptionData[4].Introduction}
          <div style={{ width: "100%" }}>
            <Separator marginHeight={48} />
          </div>
          {TarotCardsAllFullDescriptionData[4].SymbolismTitle}
          {TarotCardsAllFullDescriptionData[4].Symbolism}
        </Article>

        <Article title={TarotCardsAllFullDescriptionData[4].CardMeaning}>
          {TarotCardsAllFullDescriptionData[4].CardMeaningArticle}
        </Article>
        <span style={{ width: "100%", margin: "24px" }}></span>
        <TarotMeaningsExpositionContainer />
        <span style={{ width: "100%", margin: "24px" }}></span>
        <Article title="Card comparisons">
          {TarotCardsComparisionsData[4]()}
        </Article>
      </div>
    </main>
  );
