...
export async function generateMetadata({
  ...
  return {
    title: TarotCardsAllFullDescriptionData[16].tooltip + " " + "Meaning",
    description: CardsMetaTagsData[16],
  };
}
  ...
  return (
    <main className={styles.main}>
      <div className={styles.article_container}>
        <Article title={TarotCardsAllFullDescriptionData[16].CardName}>
          <div
            style={{
              display: "flex",
          ...
          >
            <Card img={TarotCardsPhotosAll[16]} />
          </div>
          {TarotCardsAllFullDescriptionData[16].SubTitle}
          {TarotCardsAllFullDescriptionData[16].Introduction}
          <div style={{ width: "100%" }}>
            <Separator marginHeight={48} />
          </div>
          {TarotCardsAllFullDescriptionData[16].SymbolismTitle}
          {TarotCardsAllFullDescriptionData[16].Symbolism}
        </Article>

        <Article title={TarotCardsAllFullDescriptionData[16].CardMeaning}>
          {TarotCardsAllFullDescriptionData[16].CardMeaningArticle}
        </Article>
        <span style={{ width: "100%", margin: "24px" }}></span>
        <TarotMeaningsExpositionContainer />
        <span style={{ width: "100%", margin: "24px" }}></span>
        <Article title="Card comparisons">
          {TarotCardsComparisionsData[16]()}
        </Article>
      </div>
    </main>
  );
