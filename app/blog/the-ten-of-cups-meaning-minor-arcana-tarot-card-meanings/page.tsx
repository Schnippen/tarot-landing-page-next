...
export async function generateMetadata({
  ...
  return {
    title: TarotCardsAllFullDescriptionData[45].tooltip + " " + "Meaning",
    description: CardsMetaTagsData[45],
  };
}
  ...
  return (
    <main className={styles.main}>
      <div className={styles.article_container}>
        <Article title={TarotCardsAllFullDescriptionData[45].CardName}>
          <div
            style={{
              display: "flex",
          ...
          >
            <Card img={TarotCardsPhotosAll[45]} />
          </div>
          {TarotCardsAllFullDescriptionData[45].SubTitle}
          {TarotCardsAllFullDescriptionData[45].Introduction}
          <div style={{ width: "100%" }}>
            <Separator marginHeight={48} />
          </div>
          {TarotCardsAllFullDescriptionData[45].SymbolismTitle}
          {TarotCardsAllFullDescriptionData[45].Symbolism}
        </Article>

        <Article title={TarotCardsAllFullDescriptionData[45].CardMeaning}>
          {TarotCardsAllFullDescriptionData[45].CardMeaningArticle}
        </Article>
        <span style={{ width: "100%", margin: "24px" }}></span>
        <TarotMeaningsExpositionContainer />
        <span style={{ width: "100%", margin: "24px" }}></span>
        <Article title="Card comparisons">
          {TarotCardsComparisionsData[45]()}
        </Article>
      </div>
    </main>
  );
