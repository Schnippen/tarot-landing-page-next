...
export async function generateMetadata({
  ...
  return {
    title: TarotCardsAllFullDescriptionData[21].tooltip + " " + "Meaning",
    description: CardsMetaTagsData[21],
  };
}
  ...
  return (
    <main className={styles.main}>
      <div className={styles.article_container}>
        <Article title={TarotCardsAllFullDescriptionData[21].CardName}>
          <div
            style={{
              display: "flex",
          ...
          >
            <Card img={TarotCardsPhotosAll[21]} />
          </div>
          {TarotCardsAllFullDescriptionData[21].SubTitle}
          {TarotCardsAllFullDescriptionData[21].Introduction}
          <div style={{ width: "100%" }}>
            <Separator marginHeight={48} />
          </div>
          {TarotCardsAllFullDescriptionData[21].SymbolismTitle}
          {TarotCardsAllFullDescriptionData[21].Symbolism}
        </Article>

        <Article title={TarotCardsAllFullDescriptionData[21].CardMeaning}>
          {TarotCardsAllFullDescriptionData[21].CardMeaningArticle}
        </Article>
        <span style={{ width: "100%", margin: "24px" }}></span>
        <TarotMeaningsExpositionContainer />
        <span style={{ width: "100%", margin: "24px" }}></span>
        <Article title="Card comparisons">
          {TarotCardsComparisionsData[21]()}
        </Article>
      </div>
    </main>
  );
