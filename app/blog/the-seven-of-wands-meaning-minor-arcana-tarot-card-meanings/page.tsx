...
export async function generateMetadata({
  ...
  return {
    title: TarotCardsAllFullDescriptionData[28].tooltip + " " + "Meaning",
    description: CardsMetaTagsData[28],
  };
}
  ...
  return (
    <main className={styles.main}>
      <div className={styles.article_container}>
        <Article title={TarotCardsAllFullDescriptionData[28].CardName}>
          <div
            style={{
              display: "flex",
          ...
          >
            <Card img={TarotCardsPhotosAll[28]} />
          </div>
          {TarotCardsAllFullDescriptionData[28].SubTitle}
          {TarotCardsAllFullDescriptionData[28].Introduction}
          <div style={{ width: "100%" }}>
            <Separator marginHeight={48} />
          </div>
          {TarotCardsAllFullDescriptionData[28].SymbolismTitle}
          {TarotCardsAllFullDescriptionData[28].Symbolism}
        </Article>

        <Article title={TarotCardsAllFullDescriptionData[28].CardMeaning}>
          {TarotCardsAllFullDescriptionData[28].CardMeaningArticle}
        </Article>
        <span style={{ width: "100%", margin: "24px" }}></span>
        <TarotMeaningsExpositionContainer />
        <span style={{ width: "100%", margin: "24px" }}></span>
        <Article title="Card comparisons">
          {TarotCardsComparisionsData[28]()}
        </Article>
      </div>
    </main>
  );
