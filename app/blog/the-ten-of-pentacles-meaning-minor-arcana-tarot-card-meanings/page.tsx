...
export async function generateMetadata({
  ...
  return {
    title: TarotCardsAllFullDescriptionData[73].tooltip + " " + "Meaning",
    description: CardsMetaTagsData[73],
  };
}
  ...
  return (
    <main className={styles.main}>
      <div className={styles.article_container}>
        <Article title={TarotCardsAllFullDescriptionData[73].CardName}>
          <div
            style={{
              display: "flex",
          ...
          >
            <Card img={TarotCardsPhotosAll[73]} />
          </div>
          {TarotCardsAllFullDescriptionData[73].SubTitle}
          {TarotCardsAllFullDescriptionData[73].Introduction}
          <div style={{ width: "100%" }}>
            <Separator marginHeight={48} />
          </div>
          {TarotCardsAllFullDescriptionData[73].SymbolismTitle}
          {TarotCardsAllFullDescriptionData[73].Symbolism}
        </Article>

        <Article title={TarotCardsAllFullDescriptionData[73].CardMeaning}>
          {TarotCardsAllFullDescriptionData[73].CardMeaningArticle}
        </Article>
        <span style={{ width: "100%", margin: "24px" }}></span>
        <TarotMeaningsExpositionContainer />
        <span style={{ width: "100%", margin: "24px" }}></span>
        <Article title="Card comparisons">
          {TarotCardsComparisionsData[73]()}
        </Article>
      </div>
    </main>
  );
