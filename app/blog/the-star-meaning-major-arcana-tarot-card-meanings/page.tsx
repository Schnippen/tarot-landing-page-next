...
export async function generateMetadata({
  ...
  return {
    title: TarotCardsAllFullDescriptionData[17].tooltip + " " + "Meaning",
    description: CardsMetaTagsData[17],
  };
}
  ...
  return (
    <main className={styles.main}>
      <div className={styles.article_container}>
        <Article title={TarotCardsAllFullDescriptionData[17].CardName}>
          <div
            style={{
              display: "flex",
          ...
          >
            <Card img={TarotCardsPhotosAll[17]} />
          </div>
          {TarotCardsAllFullDescriptionData[17].SubTitle}
          {TarotCardsAllFullDescriptionData[17].Introduction}
          <div style={{ width: "100%" }}>
            <Separator marginHeight={48} />
          </div>
          {TarotCardsAllFullDescriptionData[17].SymbolismTitle}
          {TarotCardsAllFullDescriptionData[17].Symbolism}
        </Article>

        <Article title={TarotCardsAllFullDescriptionData[17].CardMeaning}>
          {TarotCardsAllFullDescriptionData[17].CardMeaningArticle}
        </Article>
        <span style={{ width: "100%", margin: "24px" }}></span>
        <TarotMeaningsExpositionContainer />
        <span style={{ width: "100%", margin: "24px" }}></span>
        <Article title="Card comparisons">
          {TarotCardsComparisionsData[17]()}
        </Article>
      </div>
    </main>
  );
