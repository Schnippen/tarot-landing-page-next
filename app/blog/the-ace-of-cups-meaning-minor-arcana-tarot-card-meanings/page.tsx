...
export async function generateMetadata({
  ...
  return {
    title: TarotCardsAllFullDescriptionData[36].tooltip + " " + "Meaning",
    description: CardsMetaTagsData[36],
  };
}
  ...
  return (
    <main className={styles.main}>
      <div className={styles.article_container}>
        <Article title={TarotCardsAllFullDescriptionData[36].CardName}>
          <div
            style={{
              display: "flex",
          ...
          >
            <Card img={TarotCardsPhotosAll[36]} />
          </div>
          {TarotCardsAllFullDescriptionData[36].SubTitle}
          {TarotCardsAllFullDescriptionData[36].Introduction}
          <div style={{ width: "100%" }}>
            <Separator marginHeight={48} />
          </div>
          {TarotCardsAllFullDescriptionData[36].SymbolismTitle}
          {TarotCardsAllFullDescriptionData[36].Symbolism}
        </Article>

        <Article title={TarotCardsAllFullDescriptionData[36].CardMeaning}>
          {TarotCardsAllFullDescriptionData[36].CardMeaningArticle}
        </Article>
        <span style={{ width: "100%", margin: "24px" }}></span>
        <TarotMeaningsExpositionContainer />
        <span style={{ width: "100%", margin: "24px" }}></span>
        <Article title="Card comparisons">
          {TarotCardsComparisionsData[36]()}
        </Article>
      </div>
    </main>
  );
