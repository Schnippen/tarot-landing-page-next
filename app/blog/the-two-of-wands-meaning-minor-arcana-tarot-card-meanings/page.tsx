...
export async function generateMetadata({
  ...
  return {
    title: TarotCardsAllFullDescriptionData[23].tooltip + " " + "Meaning",
    description: CardsMetaTagsData[23],
  };
}
  ...
  return (
    <main className={styles.main}>
      <div className={styles.article_container}>
        <Article title={TarotCardsAllFullDescriptionData[23].CardName}>
          <div
            style={{
              display: "flex",
          ...
          >
            <Card img={TarotCardsPhotosAll[23]} />
          </div>
          {TarotCardsAllFullDescriptionData[23].SubTitle}
          {TarotCardsAllFullDescriptionData[23].Introduction}
          <div style={{ width: "100%" }}>
            <Separator marginHeight={48} />
          </div>
          {TarotCardsAllFullDescriptionData[23].SymbolismTitle}
          {TarotCardsAllFullDescriptionData[23].Symbolism}
        </Article>

        <Article title={TarotCardsAllFullDescriptionData[23].CardMeaning}>
          {TarotCardsAllFullDescriptionData[23].CardMeaningArticle}
        </Article>
        <span style={{ width: "100%", margin: "24px" }}></span>
        <TarotMeaningsExpositionContainer />
        <span style={{ width: "100%", margin: "24px" }}></span>
        <Article title="Card comparisons">
          {TarotCardsComparisionsData[23]()}
        </Article>
      </div>
    </main>
  );
