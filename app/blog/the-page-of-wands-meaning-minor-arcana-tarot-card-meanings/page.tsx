...
export async function generateMetadata({
  ...
  return {
    title: TarotCardsAllFullDescriptionData[32].tooltip + " " + "Meaning",
    description: CardsMetaTagsData[32],
  };
}
  ...
  return (
    <main className={styles.main}>
      <div className={styles.article_container}>
        <Article title={TarotCardsAllFullDescriptionData[32].CardName}>
          <div
            style={{
              display: "flex",
          ...
          >
            <Card img={TarotCardsPhotosAll[32]} />
          </div>
          {TarotCardsAllFullDescriptionData[32].SubTitle}
          {TarotCardsAllFullDescriptionData[32].Introduction}
          <div style={{ width: "100%" }}>
            <Separator marginHeight={48} />
          </div>
          {TarotCardsAllFullDescriptionData[32].SymbolismTitle}
          {TarotCardsAllFullDescriptionData[32].Symbolism}
        </Article>

        <Article title={TarotCardsAllFullDescriptionData[32].CardMeaning}>
          {TarotCardsAllFullDescriptionData[32].CardMeaningArticle}
        </Article>
        <span style={{ width: "100%", margin: "24px" }}></span>
        <TarotMeaningsExpositionContainer />
        <span style={{ width: "100%", margin: "24px" }}></span>
        <Article title="Card comparisons">
          {TarotCardsComparisionsData[32]()}
        </Article>
      </div>
    </main>
  );
