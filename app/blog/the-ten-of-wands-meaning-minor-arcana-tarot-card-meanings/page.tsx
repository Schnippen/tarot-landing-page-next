...
export async function generateMetadata({
  ...
  return {
    title: TarotCardsAllFullDescriptionData[31].tooltip + " " + "Meaning",
    description: CardsMetaTagsData[31],
  };
}
  ...
  return (
    <main className={styles.main}>
      <div className={styles.article_container}>
        <Article title={TarotCardsAllFullDescriptionData[31].CardName}>
          <div
            style={{
              display: "flex",
          ...
          >
            <Card img={TarotCardsPhotosAll[31]} />
          </div>
          {TarotCardsAllFullDescriptionData[31].SubTitle}
          {TarotCardsAllFullDescriptionData[31].Introduction}
          <div style={{ width: "100%" }}>
            <Separator marginHeight={48} />
          </div>
          {TarotCardsAllFullDescriptionData[31].SymbolismTitle}
          {TarotCardsAllFullDescriptionData[31].Symbolism}
        </Article>

        <Article title={TarotCardsAllFullDescriptionData[31].CardMeaning}>
          {TarotCardsAllFullDescriptionData[31].CardMeaningArticle}
        </Article>
        <span style={{ width: "100%", margin: "24px" }}></span>
        <TarotMeaningsExpositionContainer />
        <span style={{ width: "100%", margin: "24px" }}></span>
        <Article title="Card comparisons">
          {TarotCardsComparisionsData[31]()}
        </Article>
      </div>
    </main>
  );
