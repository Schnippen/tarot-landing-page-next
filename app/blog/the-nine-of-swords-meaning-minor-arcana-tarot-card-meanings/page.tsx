...
export async function generateMetadata({
  ...
  return {
    title: TarotCardsAllFullDescriptionData[58].tooltip + " " + "Meaning",
    description: CardsMetaTagsData[58],
  };
}
  ...
  return (
    <main className={styles.main}>
      <div className={styles.article_container}>
        <Article title={TarotCardsAllFullDescriptionData[58].CardName}>
          <div
            style={{
              display: "flex",
          ...
          >
            <Card img={TarotCardsPhotosAll[58]} />
          </div>
          {TarotCardsAllFullDescriptionData[58].SubTitle}
          {TarotCardsAllFullDescriptionData[58].Introduction}
          <div style={{ width: "100%" }}>
            <Separator marginHeight={48} />
          </div>
          {TarotCardsAllFullDescriptionData[58].SymbolismTitle}
          {TarotCardsAllFullDescriptionData[58].Symbolism}
        </Article>

        <Article title={TarotCardsAllFullDescriptionData[58].CardMeaning}>
          {TarotCardsAllFullDescriptionData[58].CardMeaningArticle}
        </Article>
        <span style={{ width: "100%", margin: "24px" }}></span>
        <TarotMeaningsExpositionContainer />
        <span style={{ width: "100%", margin: "24px" }}></span>
        <Article title="Card comparisons">
          {TarotCardsComparisionsData[58]()}
        </Article>
      </div>
    </main>
  );
