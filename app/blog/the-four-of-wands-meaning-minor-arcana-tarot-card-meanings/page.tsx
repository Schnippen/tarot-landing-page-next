...
export async function generateMetadata({
  ...
  return {
    title: TarotCardsAllFullDescriptionData[25].tooltip + " " + "Meaning",
    description: CardsMetaTagsData[25],
  };
}
  ...
  return (
    <main className={styles.main}>
      <div className={styles.article_container}>
        <Article title={TarotCardsAllFullDescriptionData[25].CardName}>
          <div
            style={{
              display: "flex",
          ...
          >
            <Card img={TarotCardsPhotosAll[25]} />
          </div>
          {TarotCardsAllFullDescriptionData[25].SubTitle}
          {TarotCardsAllFullDescriptionData[25].Introduction}
          <div style={{ width: "100%" }}>
            <Separator marginHeight={48} />
          </div>
          {TarotCardsAllFullDescriptionData[25].SymbolismTitle}
          {TarotCardsAllFullDescriptionData[25].Symbolism}
        </Article>

        <Article title={TarotCardsAllFullDescriptionData[25].CardMeaning}>
          {TarotCardsAllFullDescriptionData[25].CardMeaningArticle}
        </Article>
        <span style={{ width: "100%", margin: "24px" }}></span>
        <TarotMeaningsExpositionContainer />
        <span style={{ width: "100%", margin: "24px" }}></span>
        <Article title="Card comparisons">
          {TarotCardsComparisionsData[25]()}
        </Article>
      </div>
    </main>
  );
