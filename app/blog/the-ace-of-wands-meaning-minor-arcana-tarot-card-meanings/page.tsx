...
export async function generateMetadata({
  ...
  return {
    title: TarotCardsAllFullDescriptionData[22].tooltip + " " + "Meaning",
    description: CardsMetaTagsData[22],
  };
}
  ...
  return (
    <main className={styles.main}>
      <div className={styles.article_container}>
        <Article title={TarotCardsAllFullDescriptionData[22].CardName}>
          <div
            style={{
              display: "flex",
          ...
          >
            <Card img={TarotCardsPhotosAll[22]} />
          </div>
          {TarotCardsAllFullDescriptionData[22].SubTitle}
          {TarotCardsAllFullDescriptionData[22].Introduction}
          <div style={{ width: "100%" }}>
            <Separator marginHeight={48} />
          </div>
          {TarotCardsAllFullDescriptionData[22].SymbolismTitle}
          {TarotCardsAllFullDescriptionData[22].Symbolism}
        </Article>

        <Article title={TarotCardsAllFullDescriptionData[22].CardMeaning}>
          {TarotCardsAllFullDescriptionData[22].CardMeaningArticle}
        </Article>
        <span style={{ width: "100%", margin: "24px" }}></span>
        <TarotMeaningsExpositionContainer />
        <span style={{ width: "100%", margin: "24px" }}></span>
        <Article title="Card comparisons">
          {TarotCardsComparisionsData[22]()}
        </Article>
      </div>
    </main>
  );
