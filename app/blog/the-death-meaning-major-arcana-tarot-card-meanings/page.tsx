...
export async function generateMetadata({
  ...
  return {
    title: TarotCardsAllFullDescriptionData[13].tooltip + " " + "Meaning",
    description: CardsMetaTagsData[13],
  };
}
  ...
  return (
    <main className={styles.main}>
      <div className={styles.article_container}>
        <Article title={TarotCardsAllFullDescriptionData[13].CardName}>
          <div
            style={{
              display: "flex",
          ...
          >
            <Card img={TarotCardsPhotosAll[13]} />
          </div>
          {TarotCardsAllFullDescriptionData[13].SubTitle}
          {TarotCardsAllFullDescriptionData[13].Introduction}
          <div style={{ width: "100%" }}>
            <Separator marginHeight={48} />
          </div>
          {TarotCardsAllFullDescriptionData[13].SymbolismTitle}
          {TarotCardsAllFullDescriptionData[13].Symbolism}
        </Article>

        <Article title={TarotCardsAllFullDescriptionData[13].CardMeaning}>
          {TarotCardsAllFullDescriptionData[13].CardMeaningArticle}
        </Article>
        <span style={{ width: "100%", margin: "24px" }}></span>
        <TarotMeaningsExpositionContainer />
        <span style={{ width: "100%", margin: "24px" }}></span>
        <Article title="Card comparisons">
          {TarotCardsComparisionsData[13]()}
        </Article>
      </div>
    </main>
  );
