...
export async function generateMetadata({
  ...
  return {
    title: TarotCardsAllFullDescriptionData[71].tooltip + " " + "Meaning",
    description: CardsMetaTagsData[71],
  };
}
  ...
  return (
    <main className={styles.main}>
      <div className={styles.article_container}>
        <Article title={TarotCardsAllFullDescriptionData[71].CardName}>
          <div
            style={{
              display: "flex",
          ...
          >
            <Card img={TarotCardsPhotosAll[71]} />
          </div>
          {TarotCardsAllFullDescriptionData[71].SubTitle}
          {TarotCardsAllFullDescriptionData[71].Introduction}
          <div style={{ width: "100%" }}>
            <Separator marginHeight={48} />
          </div>
          {TarotCardsAllFullDescriptionData[71].SymbolismTitle}
          {TarotCardsAllFullDescriptionData[71].Symbolism}
        </Article>

        <Article title={TarotCardsAllFullDescriptionData[71].CardMeaning}>
          {TarotCardsAllFullDescriptionData[71].CardMeaningArticle}
        </Article>
        <span style={{ width: "100%", margin: "24px" }}></span>
        <TarotMeaningsExpositionContainer />
        <span style={{ width: "100%", margin: "24px" }}></span>
        <Article title="Card comparisons">
          {TarotCardsComparisionsData[71]()}
        </Article>
      </div>
    </main>
  );
