...
export async function generateMetadata({
  ...
  return {
    title: TarotCardsAllFullDescriptionData[53].tooltip + " " + "Meaning",
    description: CardsMetaTagsData[53],
  };
}
  ...
  return (
    <main className={styles.main}>
      <div className={styles.article_container}>
        <Article title={TarotCardsAllFullDescriptionData[53].CardName}>
          <div
            style={{
              display: "flex",
          ...
          >
            <Card img={TarotCardsPhotosAll[53]} />
          </div>
          {TarotCardsAllFullDescriptionData[53].SubTitle}
          {TarotCardsAllFullDescriptionData[53].Introduction}
          <div style={{ width: "100%" }}>
            <Separator marginHeight={48} />
          </div>
          {TarotCardsAllFullDescriptionData[53].SymbolismTitle}
          {TarotCardsAllFullDescriptionData[53].Symbolism}
        </Article>

        <Article title={TarotCardsAllFullDescriptionData[53].CardMeaning}>
          {TarotCardsAllFullDescriptionData[53].CardMeaningArticle}
        </Article>
        <span style={{ width: "100%", margin: "24px" }}></span>
        <TarotMeaningsExpositionContainer />
        <span style={{ width: "100%", margin: "24px" }}></span>
        <Article title="Card comparisons">
          {TarotCardsComparisionsData[53]()}
        </Article>
      </div>
    </main>
  );
