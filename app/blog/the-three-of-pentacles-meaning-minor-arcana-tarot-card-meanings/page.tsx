...
export async function generateMetadata({
  ...
  return {
    title: TarotCardsAllFullDescriptionData[66].tooltip + " " + "Meaning",
    description: CardsMetaTagsData[66],
  };
}
  ...
  return (
    <main className={styles.main}>
      <div className={styles.article_container}>
        <Article title={TarotCardsAllFullDescriptionData[66].CardName}>
          <div
            style={{
              display: "flex",
          ...
          >
            <Card img={TarotCardsPhotosAll[66]} />
          </div>
          {TarotCardsAllFullDescriptionData[66].SubTitle}
          {TarotCardsAllFullDescriptionData[66].Introduction}
          <div style={{ width: "100%" }}>
            <Separator marginHeight={48} />
          </div>
          {TarotCardsAllFullDescriptionData[66].SymbolismTitle}
          {TarotCardsAllFullDescriptionData[66].Symbolism}
        </Article>

        <Article title={TarotCardsAllFullDescriptionData[66].CardMeaning}>
          {TarotCardsAllFullDescriptionData[66].CardMeaningArticle}
        </Article>
        <span style={{ width: "100%", margin: "24px" }}></span>
        <TarotMeaningsExpositionContainer />
        <span style={{ width: "100%", margin: "24px" }}></span>
        <Article title="Card comparisons">
          {TarotCardsComparisionsData[66]()}
        </Article>
      </div>
    </main>
  );
