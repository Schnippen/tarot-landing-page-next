...
export async function generateMetadata({
  ...
  return {
    title: TarotCardsAllFullDescriptionData[75].tooltip + " " + "Meaning",
    description: CardsMetaTagsData[75],
  };
}
  ...
  return (
    <main className={styles.main}>
      <div className={styles.article_container}>
        <Article title={TarotCardsAllFullDescriptionData[75].CardName}>
          <div
            style={{
              display: "flex",
          ...
          >
            <Card img={TarotCardsPhotosAll[75]} />
          </div>
          {TarotCardsAllFullDescriptionData[75].SubTitle}
          {TarotCardsAllFullDescriptionData[75].Introduction}
          <div style={{ width: "100%" }}>
            <Separator marginHeight={48} />
          </div>
          {TarotCardsAllFullDescriptionData[75].SymbolismTitle}
          {TarotCardsAllFullDescriptionData[75].Symbolism}
        </Article>

        <Article title={TarotCardsAllFullDescriptionData[75].CardMeaning}>
          {TarotCardsAllFullDescriptionData[75].CardMeaningArticle}
        </Article>
        <span style={{ width: "100%", margin: "24px" }}></span>
        <TarotMeaningsExpositionContainer />
        <span style={{ width: "100%", margin: "24px" }}></span>
        <Article title="Card comparisons">
          {TarotCardsComparisionsData[75]()}
        </Article>
      </div>
    </main>
  );
