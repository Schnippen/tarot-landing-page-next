...
export async function generateMetadata({
  ...
  return {
    title: TarotCardsAllFullDescriptionData[11].tooltip + " " + "Meaning",
    description: CardsMetaTagsData[11],
  };
}
  ...
  return (
    <main className={styles.main}>
      <div className={styles.article_container}>
        <Article title={TarotCardsAllFullDescriptionData[11].CardName}>
          <div
            style={{
              display: "flex",
          ...
          >
            <Card img={TarotCardsPhotosAll[11]} />
          </div>
          {TarotCardsAllFullDescriptionData[11].SubTitle}
          {TarotCardsAllFullDescriptionData[11].Introduction}
          <div style={{ width: "100%" }}>
            <Separator marginHeight={48} />
          </div>
          {TarotCardsAllFullDescriptionData[11].SymbolismTitle}
          {TarotCardsAllFullDescriptionData[11].Symbolism}
        </Article>

        <Article title={TarotCardsAllFullDescriptionData[11].CardMeaning}>
          {TarotCardsAllFullDescriptionData[11].CardMeaningArticle}
        </Article>
        <span style={{ width: "100%", margin: "24px" }}></span>
        <TarotMeaningsExpositionContainer />
        <span style={{ width: "100%", margin: "24px" }}></span>
        <Article title="Card comparisons">
          {TarotCardsComparisionsData[11]()}
        </Article>
      </div>
    </main>
  );
