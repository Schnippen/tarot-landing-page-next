...
export async function generateMetadata({
  ...
  return {
    title: TarotCardsAllFullDescriptionData[65].tooltip + " " + "Meaning",
    description: CardsMetaTagsData[65],
  };
}
  ...
  return (
    <main className={styles.main}>
      <div className={styles.article_container}>
        <Article title={TarotCardsAllFullDescriptionData[65].CardName}>
          <div
            style={{
              display: "flex",
          ...
          >
            <Card img={TarotCardsPhotosAll[65]} />
          </div>
          {TarotCardsAllFullDescriptionData[65].SubTitle}
          {TarotCardsAllFullDescriptionData[65].Introduction}
          <div style={{ width: "100%" }}>
            <Separator marginHeight={48} />
          </div>
          {TarotCardsAllFullDescriptionData[65].SymbolismTitle}
          {TarotCardsAllFullDescriptionData[65].Symbolism}
        </Article>

        <Article title={TarotCardsAllFullDescriptionData[65].CardMeaning}>
          {TarotCardsAllFullDescriptionData[65].CardMeaningArticle}
        </Article>
        <span style={{ width: "100%", margin: "24px" }}></span>
        <TarotMeaningsExpositionContainer />
        <span style={{ width: "100%", margin: "24px" }}></span>
        <Article title="Card comparisons">
          {TarotCardsComparisionsData[65]()}
        </Article>
      </div>
    </main>
  );
