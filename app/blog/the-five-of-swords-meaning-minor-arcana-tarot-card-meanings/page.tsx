...
export async function generateMetadata({
  ...
  return {
    title: TarotCardsAllFullDescriptionData[54].tooltip + " " + "Meaning",
    description: CardsMetaTagsData[54],
  };
}
  ...
  return (
    <main className={styles.main}>
      <div className={styles.article_container}>
        <Article title={TarotCardsAllFullDescriptionData[54].CardName}>
          <div
            style={{
              display: "flex",
          ...
          >
            <Card img={TarotCardsPhotosAll[54]} />
          </div>
          {TarotCardsAllFullDescriptionData[54].SubTitle}
          {TarotCardsAllFullDescriptionData[54].Introduction}
          <div style={{ width: "100%" }}>
            <Separator marginHeight={48} />
          </div>
          {TarotCardsAllFullDescriptionData[54].SymbolismTitle}
          {TarotCardsAllFullDescriptionData[54].Symbolism}
        </Article>

        <Article title={TarotCardsAllFullDescriptionData[54].CardMeaning}>
          {TarotCardsAllFullDescriptionData[54].CardMeaningArticle}
        </Article>
        <span style={{ width: "100%", margin: "24px" }}></span>
        <TarotMeaningsExpositionContainer />
        <span style={{ width: "100%", margin: "24px" }}></span>
        <Article title="Card comparisons">
          {TarotCardsComparisionsData[54]()}
        </Article>
      </div>
    </main>
  );
