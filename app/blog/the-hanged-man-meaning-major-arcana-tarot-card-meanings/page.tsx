...
export async function generateMetadata({
  ...
  return {
    title: TarotCardsAllFullDescriptionData[12].tooltip + " " + "Meaning",
    description: CardsMetaTagsData[12],
  };
}
  ...
  return (
    <main className={styles.main}>
      <div className={styles.article_container}>
        <Article title={TarotCardsAllFullDescriptionData[12].CardName}>
          <div
            style={{
              display: "flex",
          ...
          >
            <Card img={TarotCardsPhotosAll[12]} />
          </div>
          {TarotCardsAllFullDescriptionData[12].SubTitle}
          {TarotCardsAllFullDescriptionData[12].Introduction}
          <div style={{ width: "100%" }}>
            <Separator marginHeight={48} />
          </div>
          {TarotCardsAllFullDescriptionData[12].SymbolismTitle}
          {TarotCardsAllFullDescriptionData[12].Symbolism}
        </Article>

        <Article title={TarotCardsAllFullDescriptionData[12].CardMeaning}>
          {TarotCardsAllFullDescriptionData[12].CardMeaningArticle}
        </Article>
        <span style={{ width: "100%", margin: "24px" }}></span>
        <TarotMeaningsExpositionContainer />
        <span style={{ width: "100%", margin: "24px" }}></span>
        <Article title="Card comparisons">
          {TarotCardsComparisionsData[12]()}
        </Article>
      </div>
    </main>
  );
