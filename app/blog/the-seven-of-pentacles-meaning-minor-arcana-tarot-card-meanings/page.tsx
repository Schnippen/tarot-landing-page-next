...
export async function generateMetadata({
  ...
  return {
    title: TarotCardsAllFullDescriptionData[70].tooltip + " " + "Meaning",
    description: CardsMetaTagsData[70],
  };
}
  ...
  return (
    <main className={styles.main}>
      <div className={styles.article_container}>
        <Article title={TarotCardsAllFullDescriptionData[70].CardName}>
          <div
            style={{
              display: "flex",
          ...
          >
            <Card img={TarotCardsPhotosAll[70]} />
          </div>
          {TarotCardsAllFullDescriptionData[70].SubTitle}
          {TarotCardsAllFullDescriptionData[70].Introduction}
          <div style={{ width: "100%" }}>
            <Separator marginHeight={48} />
          </div>
          {TarotCardsAllFullDescriptionData[70].SymbolismTitle}
          {TarotCardsAllFullDescriptionData[70].Symbolism}
        </Article>

        <Article title={TarotCardsAllFullDescriptionData[70].CardMeaning}>
          {TarotCardsAllFullDescriptionData[70].CardMeaningArticle}
        </Article>
        <span style={{ width: "100%", margin: "24px" }}></span>
        <TarotMeaningsExpositionContainer />
        <span style={{ width: "100%", margin: "24px" }}></span>
        <Article title="Card comparisons">
          {TarotCardsComparisionsData[70]()}
        </Article>
      </div>
    </main>
  );
