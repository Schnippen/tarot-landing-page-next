...
export async function generateMetadata({
  ...
  return {
    title: TarotCardsAllFullDescriptionData[72].tooltip + " " + "Meaning",
    description: CardsMetaTagsData[72],
  };
}
  ...
  return (
    <main className={styles.main}>
      <div className={styles.article_container}>
        <Article title={TarotCardsAllFullDescriptionData[72].CardName}>
          <div
            style={{
              display: "flex",
          ...
          >
            <Card img={TarotCardsPhotosAll[72]} />
          </div>
          {TarotCardsAllFullDescriptionData[72].SubTitle}
          {TarotCardsAllFullDescriptionData[72].Introduction}
          <div style={{ width: "100%" }}>
            <Separator marginHeight={48} />
          </div>
          {TarotCardsAllFullDescriptionData[72].SymbolismTitle}
          {TarotCardsAllFullDescriptionData[72].Symbolism}
        </Article>

        <Article title={TarotCardsAllFullDescriptionData[72].CardMeaning}>
          {TarotCardsAllFullDescriptionData[72].CardMeaningArticle}
        </Article>
        <span style={{ width: "100%", margin: "24px" }}></span>
        <TarotMeaningsExpositionContainer />
        <span style={{ width: "100%", margin: "24px" }}></span>
        <Article title="Card comparisons">
          {TarotCardsComparisionsData[72]()}
        </Article>
      </div>
    </main>
  );
