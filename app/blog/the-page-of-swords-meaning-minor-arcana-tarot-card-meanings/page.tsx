...
export async function generateMetadata({
  ...
  return {
    title: TarotCardsAllFullDescriptionData[60].tooltip + " " + "Meaning",
    description: CardsMetaTagsData[60],
  };
}
  ...
  return (
    <main className={styles.main}>
      <div className={styles.article_container}>
        <Article title={TarotCardsAllFullDescriptionData[60].CardName}>
          <div
            style={{
              display: "flex",
          ...
          >
            <Card img={TarotCardsPhotosAll[60]} />
          </div>
          {TarotCardsAllFullDescriptionData[60].SubTitle}
          {TarotCardsAllFullDescriptionData[60].Introduction}
          <div style={{ width: "100%" }}>
            <Separator marginHeight={48} />
          </div>
          {TarotCardsAllFullDescriptionData[60].SymbolismTitle}
          {TarotCardsAllFullDescriptionData[60].Symbolism}
        </Article>

        <Article title={TarotCardsAllFullDescriptionData[60].CardMeaning}>
          {TarotCardsAllFullDescriptionData[60].CardMeaningArticle}
        </Article>
        <span style={{ width: "100%", margin: "24px" }}></span>
        <TarotMeaningsExpositionContainer />
        <span style={{ width: "100%", margin: "24px" }}></span>
        <Article title="Card comparisons">
          {TarotCardsComparisionsData[60]()}
        </Article>
      </div>
    </main>
  );
