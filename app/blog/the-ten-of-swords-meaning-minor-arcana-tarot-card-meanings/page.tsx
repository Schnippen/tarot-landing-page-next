...
export async function generateMetadata({
  ...
  return {
    title: TarotCardsAllFullDescriptionData[59].tooltip + " " + "Meaning",
    description: CardsMetaTagsData[59],
  };
}
  ...
  return (
    <main className={styles.main}>
      <div className={styles.article_container}>
        <Article title={TarotCardsAllFullDescriptionData[59].CardName}>
          <div
            style={{
              display: "flex",
          ...
          >
            <Card img={TarotCardsPhotosAll[59]} />
          </div>
          {TarotCardsAllFullDescriptionData[59].SubTitle}
          {TarotCardsAllFullDescriptionData[59].Introduction}
          <div style={{ width: "100%" }}>
            <Separator marginHeight={48} />
          </div>
          {TarotCardsAllFullDescriptionData[59].SymbolismTitle}
          {TarotCardsAllFullDescriptionData[59].Symbolism}
        </Article>

        <Article title={TarotCardsAllFullDescriptionData[59].CardMeaning}>
          {TarotCardsAllFullDescriptionData[59].CardMeaningArticle}
        </Article>
        <span style={{ width: "100%", margin: "24px" }}></span>
        <TarotMeaningsExpositionContainer />
        <span style={{ width: "100%", margin: "24px" }}></span>
        <Article title="Card comparisons">
          {TarotCardsComparisionsData[59]()}
        </Article>
      </div>
    </main>
  );
