...
export async function generateMetadata({
  ...
  return {
    title: TarotCardsAllFullDescriptionData[43].tooltip + " " + "Meaning",
    description: CardsMetaTagsData[43],
  };
}
  ...
  return (
    <main className={styles.main}>
      <div className={styles.article_container}>
        <Article title={TarotCardsAllFullDescriptionData[43].CardName}>
          <div
            style={{
              display: "flex",
          ...
          >
            <Card img={TarotCardsPhotosAll[43]} />
          </div>
          {TarotCardsAllFullDescriptionData[43].SubTitle}
          {TarotCardsAllFullDescriptionData[43].Introduction}
          <div style={{ width: "100%" }}>
            <Separator marginHeight={48} />
          </div>
          {TarotCardsAllFullDescriptionData[43].SymbolismTitle}
          {TarotCardsAllFullDescriptionData[43].Symbolism}
        </Article>

        <Article title={TarotCardsAllFullDescriptionData[43].CardMeaning}>
          {TarotCardsAllFullDescriptionData[43].CardMeaningArticle}
        </Article>
        <span style={{ width: "100%", margin: "24px" }}></span>
        <TarotMeaningsExpositionContainer />
        <span style={{ width: "100%", margin: "24px" }}></span>
        <Article title="Card comparisons">
          {TarotCardsComparisionsData[43]()}
        </Article>
      </div>
    </main>
  );
