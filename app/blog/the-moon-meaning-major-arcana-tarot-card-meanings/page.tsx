...
export async function generateMetadata({
  ...
  return {
    title: TarotCardsAllFullDescriptionData[18].tooltip + " " + "Meaning",
    description: CardsMetaTagsData[18],
  };
}
  ...
  return (
    <main className={styles.main}>
      <div className={styles.article_container}>
        <Article title={TarotCardsAllFullDescriptionData[18].CardName}>
          <div
            style={{
              display: "flex",
          ...
          >
            <Card img={TarotCardsPhotosAll[18]} />
          </div>
          {TarotCardsAllFullDescriptionData[18].SubTitle}
          {TarotCardsAllFullDescriptionData[18].Introduction}
          <div style={{ width: "100%" }}>
            <Separator marginHeight={48} />
          </div>
          {TarotCardsAllFullDescriptionData[18].SymbolismTitle}
          {TarotCardsAllFullDescriptionData[18].Symbolism}
        </Article>

        <Article title={TarotCardsAllFullDescriptionData[18].CardMeaning}>
          {TarotCardsAllFullDescriptionData[18].CardMeaningArticle}
        </Article>
        <span style={{ width: "100%", margin: "24px" }}></span>
        <TarotMeaningsExpositionContainer />
        <span style={{ width: "100%", margin: "24px" }}></span>
        <Article title="Card comparisons">
          {TarotCardsComparisionsData[18]()}
        </Article>
      </div>
    </main>
  );
