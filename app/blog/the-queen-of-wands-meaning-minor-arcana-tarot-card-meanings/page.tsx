...
export async function generateMetadata({
  ...
  return {
    title: TarotCardsAllFullDescriptionData[34].tooltip + " " + "Meaning",
    description: CardsMetaTagsData[34],
  };
}
  ...
  return (
    <main className={styles.main}>
      <div className={styles.article_container}>
        <Article title={TarotCardsAllFullDescriptionData[34].CardName}>
          <div
            style={{
              display: "flex",
          ...
          >
            <Card img={TarotCardsPhotosAll[34]} />
          </div>
          {TarotCardsAllFullDescriptionData[34].SubTitle}
          {TarotCardsAllFullDescriptionData[34].Introduction}
          <div style={{ width: "100%" }}>
            <Separator marginHeight={48} />
          </div>
          {TarotCardsAllFullDescriptionData[34].SymbolismTitle}
          {TarotCardsAllFullDescriptionData[34].Symbolism}
        </Article>

        <Article title={TarotCardsAllFullDescriptionData[34].CardMeaning}>
          {TarotCardsAllFullDescriptionData[34].CardMeaningArticle}
        </Article>
        <span style={{ width: "100%", margin: "24px" }}></span>
        <TarotMeaningsExpositionContainer />
        <span style={{ width: "100%", margin: "24px" }}></span>
        <Article title="Card comparisons">
          {TarotCardsComparisionsData[34]()}
        </Article>
      </div>
    </main>
  );
