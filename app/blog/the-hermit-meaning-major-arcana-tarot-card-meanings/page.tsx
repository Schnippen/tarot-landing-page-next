...
export async function generateMetadata({
  ...
  return {
    title: TarotCardsAllFullDescriptionData[9].tooltip + " " + "Meaning",
    description: CardsMetaTagsData[9],
  };
}
  ...
  return (
    <main className={styles.main}>
      <div className={styles.article_container}>
        <Article title={TarotCardsAllFullDescriptionData[9].CardName}>
          <div
            style={{
              display: "flex",
          ...
          >
            <Card img={TarotCardsPhotosAll[9]} />
          </div>
          {TarotCardsAllFullDescriptionData[9].SubTitle}
          {TarotCardsAllFullDescriptionData[9].Introduction}
          <div style={{ width: "100%" }}>
            <Separator marginHeight={48} />
          </div>
          {TarotCardsAllFullDescriptionData[9].SymbolismTitle}
          {TarotCardsAllFullDescriptionData[9].Symbolism}
        </Article>

        <Article title={TarotCardsAllFullDescriptionData[9].CardMeaning}>
          {TarotCardsAllFullDescriptionData[9].CardMeaningArticle}
        </Article>
        <span style={{ width: "100%", margin: "24px" }}></span>
        <TarotMeaningsExpositionContainer />
        <span style={{ width: "100%", margin: "24px" }}></span>
        <Article title="Card comparisons">
          {TarotCardsComparisionsData[9]()}
        </Article>
      </div>
    </main>
  );
