...
export async function generateMetadata({
  ...
  return {
    title: TarotCardsAllFullDescriptionData[0].tooltip + " " + "Meaning",
    description: CardsMetaTagsData[0],
  };
}
  ...
  return (
    <main className={styles.main}>
      <div className={styles.article_container}>
        <Article title={TarotCardsAllFullDescriptionData[0].CardName}>
          <div
            style={{
              display: "flex",
          ...
          >
            <Card img={TarotCardsPhotosAll[0]} />
          </div>
          {TarotCardsAllFullDescriptionData[0].SubTitle}
          {TarotCardsAllFullDescriptionData[0].Introduction}
          <div style={{ width: "100%" }}>
            <Separator marginHeight={48} />
          </div>
          {TarotCardsAllFullDescriptionData[0].SymbolismTitle}
          {TarotCardsAllFullDescriptionData[0].Symbolism}
        </Article>

        <Article title={TarotCardsAllFullDescriptionData[0].CardMeaning}>
          {TarotCardsAllFullDescriptionData[0].CardMeaningArticle}
        </Article>
        <span style={{ width: "100%", margin: "24px" }}></span>
        <TarotMeaningsExpositionContainer />
        <span style={{ width: "100%", margin: "24px" }}></span>
        <Article title="Card comparisons">
          {TarotCardsComparisionsData[0]()}
        </Article>
      </div>
    </main>
  );
