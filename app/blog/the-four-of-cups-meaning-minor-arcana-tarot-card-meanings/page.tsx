...
export async function generateMetadata({
  ...
  return {
    title: TarotCardsAllFullDescriptionData[39].tooltip + " " + "Meaning",
    description: CardsMetaTagsData[39],
  };
}
  ...
  return (
    <main className={styles.main}>
      <div className={styles.article_container}>
        <Article title={TarotCardsAllFullDescriptionData[39].CardName}>
          <div
            style={{
              display: "flex",
          ...
          >
            <Card img={TarotCardsPhotosAll[39]} />
          </div>
          {TarotCardsAllFullDescriptionData[39].SubTitle}
          {TarotCardsAllFullDescriptionData[39].Introduction}
          <div style={{ width: "100%" }}>
            <Separator marginHeight={48} />
          </div>
          {TarotCardsAllFullDescriptionData[39].SymbolismTitle}
          {TarotCardsAllFullDescriptionData[39].Symbolism}
        </Article>

        <Article title={TarotCardsAllFullDescriptionData[39].CardMeaning}>
          {TarotCardsAllFullDescriptionData[39].CardMeaningArticle}
        </Article>
        <span style={{ width: "100%", margin: "24px" }}></span>
        <TarotMeaningsExpositionContainer />
        <span style={{ width: "100%", margin: "24px" }}></span>
        <Article title="Card comparisons">
          {TarotCardsComparisionsData[39]()}
        </Article>
      </div>
    </main>
  );
