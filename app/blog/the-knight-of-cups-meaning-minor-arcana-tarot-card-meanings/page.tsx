...
export async function generateMetadata({
  ...
  return {
    title: TarotCardsAllFullDescriptionData[47].tooltip + " " + "Meaning",
    description: CardsMetaTagsData[47],
  };
}
  ...
  return (
    <main className={styles.main}>
      <div className={styles.article_container}>
        <Article title={TarotCardsAllFullDescriptionData[47].CardName}>
          <div
            style={{
              display: "flex",
          ...
          >
            <Card img={TarotCardsPhotosAll[47]} />
          </div>
          {TarotCardsAllFullDescriptionData[47].SubTitle}
          {TarotCardsAllFullDescriptionData[47].Introduction}
          <div style={{ width: "100%" }}>
            <Separator marginHeight={48} />
          </div>
          {TarotCardsAllFullDescriptionData[47].SymbolismTitle}
          {TarotCardsAllFullDescriptionData[47].Symbolism}
        </Article>

        <Article title={TarotCardsAllFullDescriptionData[47].CardMeaning}>
          {TarotCardsAllFullDescriptionData[47].CardMeaningArticle}
        </Article>
        <span style={{ width: "100%", margin: "24px" }}></span>
        <TarotMeaningsExpositionContainer />
        <span style={{ width: "100%", margin: "24px" }}></span>
        <Article title="Card comparisons">
          {TarotCardsComparisionsData[47]()}
        </Article>
      </div>
    </main>
  );
