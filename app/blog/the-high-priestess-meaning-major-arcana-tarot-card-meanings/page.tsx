...
export async function generateMetadata({
  ...
  return {
    title: TarotCardsAllFullDescriptionData[2].tooltip + " " + "Meaning",
    description: CardsMetaTagsData[2],
  };
}
  ...
  return (
    <main className={styles.main}>
      <div className={styles.article_container}>
        <Article title={TarotCardsAllFullDescriptionData[2].CardName}>
          <div
            style={{
              display: "flex",
          ...
          >
            <Card img={TarotCardsPhotosAll[2]} />
          </div>
          {TarotCardsAllFullDescriptionData[2].SubTitle}
          {TarotCardsAllFullDescriptionData[2].Introduction}
          <div style={{ width: "100%" }}>
            <Separator marginHeight={48} />
          </div>
          {TarotCardsAllFullDescriptionData[2].SymbolismTitle}
          {TarotCardsAllFullDescriptionData[2].Symbolism}
        </Article>

        <Article title={TarotCardsAllFullDescriptionData[2].CardMeaning}>
          {TarotCardsAllFullDescriptionData[2].CardMeaningArticle}
        </Article>
        <span style={{ width: "100%", margin: "24px" }}></span>
        <TarotMeaningsExpositionContainer />
        <span style={{ width: "100%", margin: "24px" }}></span>
        <Article title="Card comparisons">
          {TarotCardsComparisionsData[2]()}
        </Article>
      </div>
    </main>
  );
