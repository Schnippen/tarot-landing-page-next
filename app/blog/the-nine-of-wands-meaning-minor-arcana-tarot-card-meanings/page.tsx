...
export async function generateMetadata({
  ...
  return {
    title: TarotCardsAllFullDescriptionData[30].tooltip + " " + "Meaning",
    description: CardsMetaTagsData[30],
  };
}
  ...
  return (
    <main className={styles.main}>
      <div className={styles.article_container}>
        <Article title={TarotCardsAllFullDescriptionData[30].CardName}>
          <div
            style={{
              display: "flex",
          ...
          >
            <Card img={TarotCardsPhotosAll[30]} />
          </div>
          {TarotCardsAllFullDescriptionData[30].SubTitle}
          {TarotCardsAllFullDescriptionData[30].Introduction}
          <div style={{ width: "100%" }}>
            <Separator marginHeight={48} />
          </div>
          {TarotCardsAllFullDescriptionData[30].SymbolismTitle}
          {TarotCardsAllFullDescriptionData[30].Symbolism}
        </Article>

        <Article title={TarotCardsAllFullDescriptionData[30].CardMeaning}>
          {TarotCardsAllFullDescriptionData[30].CardMeaningArticle}
        </Article>
        <span style={{ width: "100%", margin: "24px" }}></span>
        <TarotMeaningsExpositionContainer />
        <span style={{ width: "100%", margin: "24px" }}></span>
        <Article title="Card comparisons">
          {TarotCardsComparisionsData[30]()}
        </Article>
      </div>
    </main>
  );
