...
export async function generateMetadata({
  ...
  return {
    title: TarotCardsAllFullDescriptionData[38].tooltip + " " + "Meaning",
    description: CardsMetaTagsData[38],
  };
}
  ...
  return (
    <main className={styles.main}>
      <div className={styles.article_container}>
        <Article title={TarotCardsAllFullDescriptionData[38].CardName}>
          <div
            style={{
              display: "flex",
          ...
          >
            <Card img={TarotCardsPhotosAll[38]} />
          </div>
          {TarotCardsAllFullDescriptionData[38].SubTitle}
          {TarotCardsAllFullDescriptionData[38].Introduction}
          <div style={{ width: "100%" }}>
            <Separator marginHeight={48} />
          </div>
          {TarotCardsAllFullDescriptionData[38].SymbolismTitle}
          {TarotCardsAllFullDescriptionData[38].Symbolism}
        </Article>

        <Article title={TarotCardsAllFullDescriptionData[38].CardMeaning}>
          {TarotCardsAllFullDescriptionData[38].CardMeaningArticle}
        </Article>
        <span style={{ width: "100%", margin: "24px" }}></span>
        <TarotMeaningsExpositionContainer />
        <span style={{ width: "100%", margin: "24px" }}></span>
        <Article title="Card comparisons">
          {TarotCardsComparisionsData[38]()}
        </Article>
      </div>
    </main>
  );
