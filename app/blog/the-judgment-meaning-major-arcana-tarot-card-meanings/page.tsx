...
export async function generateMetadata({
  ...
  return {
    title: TarotCardsAllFullDescriptionData[20].tooltip + " " + "Meaning",
    description: CardsMetaTagsData[20],
  };
}
  ...
  return (
    <main className={styles.main}>
      <div className={styles.article_container}>
        <Article title={TarotCardsAllFullDescriptionData[20].CardName}>
          <div
            style={{
              display: "flex",
          ...
          >
            <Card img={TarotCardsPhotosAll[20]} />
          </div>
          {TarotCardsAllFullDescriptionData[20].SubTitle}
          {TarotCardsAllFullDescriptionData[20].Introduction}
          <div style={{ width: "100%" }}>
            <Separator marginHeight={48} />
          </div>
          {TarotCardsAllFullDescriptionData[20].SymbolismTitle}
          {TarotCardsAllFullDescriptionData[20].Symbolism}
        </Article>

        <Article title={TarotCardsAllFullDescriptionData[20].CardMeaning}>
          {TarotCardsAllFullDescriptionData[20].CardMeaningArticle}
        </Article>
        <span style={{ width: "100%", margin: "24px" }}></span>
        <TarotMeaningsExpositionContainer />
        <span style={{ width: "100%", margin: "24px" }}></span>
        <Article title="Card comparisons">
          {TarotCardsComparisionsData[20]()}
        </Article>
      </div>
    </main>
  );
