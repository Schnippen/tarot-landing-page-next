...
export async function generateMetadata({
  ...
  return {
    title: TarotCardsAllFullDescriptionData[14].tooltip + " " + "Meaning",
    description: CardsMetaTagsData[14],
  };
}
  ...
  return (
    <main className={styles.main}>
      <div className={styles.article_container}>
        <Article title={TarotCardsAllFullDescriptionData[14].CardName}>
          <div
            style={{
              display: "flex",
          ...
          >
            <Card img={TarotCardsPhotosAll[14]} />
          </div>
          {TarotCardsAllFullDescriptionData[14].SubTitle}
          {TarotCardsAllFullDescriptionData[14].Introduction}
          <div style={{ width: "100%" }}>
            <Separator marginHeight={48} />
          </div>
          {TarotCardsAllFullDescriptionData[14].SymbolismTitle}
          {TarotCardsAllFullDescriptionData[14].Symbolism}
        </Article>

        <Article title={TarotCardsAllFullDescriptionData[14].CardMeaning}>
          {TarotCardsAllFullDescriptionData[14].CardMeaningArticle}
        </Article>
        <span style={{ width: "100%", margin: "24px" }}></span>
        <TarotMeaningsExpositionContainer />
        <span style={{ width: "100%", margin: "24px" }}></span>
        <Article title="Card comparisons">
          {TarotCardsComparisionsData[14]()}
        </Article>
      </div>
    </main>
  );
