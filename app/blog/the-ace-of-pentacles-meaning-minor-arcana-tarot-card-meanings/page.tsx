...
export async function generateMetadata({
  ...
  return {
    title: TarotCardsAllFullDescriptionData[64].tooltip + " " + "Meaning",
    description: CardsMetaTagsData[64],
  };
}
  ...
  return (
    <main className={styles.main}>
      <div className={styles.article_container}>
        <Article title={TarotCardsAllFullDescriptionData[64].CardName}>
          <div
            style={{
              display: "flex",
          ...
          >
            <Card img={TarotCardsPhotosAll[64]} />
          </div>
          {TarotCardsAllFullDescriptionData[64].SubTitle}
          {TarotCardsAllFullDescriptionData[64].Introduction}
          <div style={{ width: "100%" }}>
            <Separator marginHeight={48} />
          </div>
          {TarotCardsAllFullDescriptionData[64].SymbolismTitle}
          {TarotCardsAllFullDescriptionData[64].Symbolism}
        </Article>

        <Article title={TarotCardsAllFullDescriptionData[64].CardMeaning}>
          {TarotCardsAllFullDescriptionData[64].CardMeaningArticle}
        </Article>
        <span style={{ width: "100%", margin: "24px" }}></span>
        <TarotMeaningsExpositionContainer />
        <span style={{ width: "100%", margin: "24px" }}></span>
        <Article title="Card comparisons">
          {TarotCardsComparisionsData[64]()}
        </Article>
      </div>
    </main>
  );
