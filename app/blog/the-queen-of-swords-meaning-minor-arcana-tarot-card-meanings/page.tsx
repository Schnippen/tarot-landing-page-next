...
export async function generateMetadata({
  ...
  return {
    title: TarotCardsAllFullDescriptionData[62].tooltip + " " + "Meaning",
    description: CardsMetaTagsData[62],
  };
}
  ...
  return (
    <main className={styles.main}>
      <div className={styles.article_container}>
        <Article title={TarotCardsAllFullDescriptionData[62].CardName}>
          <div
            style={{
              display: "flex",
          ...
          >
            <Card img={TarotCardsPhotosAll[62]} />
          </div>
          {TarotCardsAllFullDescriptionData[62].SubTitle}
          {TarotCardsAllFullDescriptionData[62].Introduction}
          <div style={{ width: "100%" }}>
            <Separator marginHeight={48} />
          </div>
          {TarotCardsAllFullDescriptionData[62].SymbolismTitle}
          {TarotCardsAllFullDescriptionData[62].Symbolism}
        </Article>

        <Article title={TarotCardsAllFullDescriptionData[62].CardMeaning}>
          {TarotCardsAllFullDescriptionData[62].CardMeaningArticle}
        </Article>
        <span style={{ width: "100%", margin: "24px" }}></span>
        <TarotMeaningsExpositionContainer />
        <span style={{ width: "100%", margin: "24px" }}></span>
        <Article title="Card comparisons">
          {TarotCardsComparisionsData[62]()}
        </Article>
      </div>
    </main>
  );
