...
export async function generateMetadata({
  ...
  return {
    title: TarotCardsAllFullDescriptionData[61].tooltip + " " + "Meaning",
    description: CardsMetaTagsData[61],
  };
}
  ...
  return (
    <main className={styles.main}>
      <div className={styles.article_container}>
        <Article title={TarotCardsAllFullDescriptionData[61].CardName}>
          <div
            style={{
              display: "flex",
          ...
          >
            <Card img={TarotCardsPhotosAll[61]} />
          </div>
          {TarotCardsAllFullDescriptionData[61].SubTitle}
          {TarotCardsAllFullDescriptionData[61].Introduction}
          <div style={{ width: "100%" }}>
            <Separator marginHeight={48} />
          </div>
          {TarotCardsAllFullDescriptionData[61].SymbolismTitle}
          {TarotCardsAllFullDescriptionData[61].Symbolism}
        </Article>

        <Article title={TarotCardsAllFullDescriptionData[61].CardMeaning}>
          {TarotCardsAllFullDescriptionData[61].CardMeaningArticle}
        </Article>
        <span style={{ width: "100%", margin: "24px" }}></span>
        <TarotMeaningsExpositionContainer />
        <span style={{ width: "100%", margin: "24px" }}></span>
        <Article title="Card comparisons">
          {TarotCardsComparisionsData[61]()}
        </Article>
      </div>
    </main>
  );
