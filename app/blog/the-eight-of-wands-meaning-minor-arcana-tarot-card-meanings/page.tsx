...
export async function generateMetadata({
  ...
  return {
    title: TarotCardsAllFullDescriptionData[29].tooltip + " " + "Meaning",
    description: CardsMetaTagsData[29],
  };
}
  ...
  return (
    <main className={styles.main}>
      <div className={styles.article_container}>
        <Article title={TarotCardsAllFullDescriptionData[29].CardName}>
          <div
            style={{
              display: "flex",
          ...
          >
            <Card img={TarotCardsPhotosAll[29]} />
          </div>
          {TarotCardsAllFullDescriptionData[29].SubTitle}
          {TarotCardsAllFullDescriptionData[29].Introduction}
          <div style={{ width: "100%" }}>
            <Separator marginHeight={48} />
          </div>
          {TarotCardsAllFullDescriptionData[29].SymbolismTitle}
          {TarotCardsAllFullDescriptionData[29].Symbolism}
        </Article>

        <Article title={TarotCardsAllFullDescriptionData[29].CardMeaning}>
          {TarotCardsAllFullDescriptionData[29].CardMeaningArticle}
        </Article>
        <span style={{ width: "100%", margin: "24px" }}></span>
        <TarotMeaningsExpositionContainer />
        <span style={{ width: "100%", margin: "24px" }}></span>
        <Article title="Card comparisons">
          {TarotCardsComparisionsData[29]()}
        </Article>
      </div>
    </main>
  );
