...
export async function generateMetadata({
  ...
  return {
    title: TarotCardsAllFullDescriptionData[24].tooltip + " " + "Meaning",
    description: CardsMetaTagsData[24],
  };
}
  ...
  return (
    <main className={styles.main}>
      <div className={styles.article_container}>
        <Article title={TarotCardsAllFullDescriptionData[24].CardName}>
          <div
            style={{
              display: "flex",
          ...
          >
            <Card img={TarotCardsPhotosAll[24]} />
          </div>
          {TarotCardsAllFullDescriptionData[24].SubTitle}
          {TarotCardsAllFullDescriptionData[24].Introduction}
          <div style={{ width: "100%" }}>
            <Separator marginHeight={48} />
          </div>
          {TarotCardsAllFullDescriptionData[24].SymbolismTitle}
          {TarotCardsAllFullDescriptionData[24].Symbolism}
        </Article>

        <Article title={TarotCardsAllFullDescriptionData[24].CardMeaning}>
          {TarotCardsAllFullDescriptionData[24].CardMeaningArticle}
        </Article>
        <span style={{ width: "100%", margin: "24px" }}></span>
        <TarotMeaningsExpositionContainer />
        <span style={{ width: "100%", margin: "24px" }}></span>
        <Article title="Card comparisons">
          {TarotCardsComparisionsData[24]()}
        </Article>
      </div>
    </main>
  );
