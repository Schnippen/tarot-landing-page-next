...
export async function generateMetadata({
  ...
  return {
    title: TarotCardsAllFullDescriptionData[77].tooltip + " " + "Meaning",
    description: CardsMetaTagsData[77],
  };
}
  ...
  return (
    <main className={styles.main}>
      <div className={styles.article_container}>
        <Article title={TarotCardsAllFullDescriptionData[77].CardName}>
          <div
            style={{
              display: "flex",
          ...
          >
            <Card img={TarotCardsPhotosAll[77]} />
          </div>
          {TarotCardsAllFullDescriptionData[77].SubTitle}
          {TarotCardsAllFullDescriptionData[77].Introduction}
          <div style={{ width: "100%" }}>
            <Separator marginHeight={48} />
          </div>
          {TarotCardsAllFullDescriptionData[77].SymbolismTitle}
          {TarotCardsAllFullDescriptionData[77].Symbolism}
        </Article>

        <Article title={TarotCardsAllFullDescriptionData[77].CardMeaning}>
          {TarotCardsAllFullDescriptionData[77].CardMeaningArticle}
        </Article>
        <span style={{ width: "100%", margin: "24px" }}></span>
        <TarotMeaningsExpositionContainer />
        <span style={{ width: "100%", margin: "24px" }}></span>
        <Article title="Card comparisons">
          {TarotCardsComparisionsData[77]()}
        </Article>
      </div>
    </main>
  );
